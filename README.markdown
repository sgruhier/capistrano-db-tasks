...
Commands mysql, mysqldump (or pg\_dump, psql, or mongodump, mongorestore), bzip2 and unbzip2 (or gzip) must be in your PATH
...
```ruby
    ...
    # if you prefer bzip2/unbzip2 instead of gzip (not working with mongo)
